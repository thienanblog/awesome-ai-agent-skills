...
```text
Use $run-reviewable-subtask-loop to split this migration into right-sized, coherent slices that are meaningful to code, review, and test, then deliver them with one final review request.
```
