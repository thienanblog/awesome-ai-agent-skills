...
The mindset skill checks sibling skills in this library and can switch to the right workflow when the task needs reviewable multi-slice delivery, UI concepts, tests, debugging, performance, documentation, design systems, or deployment guidance.
